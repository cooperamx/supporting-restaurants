<template>
  <div class="columns is-centered" slot="main">
    <div class="column is-half content">
      ...
      <h2 class="title">¿Qué pensamos que puede ayudar?</h2>
      <ul>
        <li>
          Vender certificados de regalo como mecanismo de preventas hasta que la
          crisis termine.
        </li>
        <li>
      ...
      <p>
        Somos consumidores locales, y vaya que extrañamos ya a muchos locales de
      ...
      <ul>
        ...
        <li>
          Un texto que haga que la gente empatice con tu negocio y que motive a
          los usuarios.
        </li>
        <li>
          Opcionalmente, te dejaremos poner un video que previamente hayas
          subido a la plataforma de YouTube, para que puedas mandar un mensaje
          de cómo están viviendo la crisis y cómo podemos ayudar. Links a tus
          redes sociales, aceptamos links de Facebook, Instagram y Twitter.
        </li>
      </ul>

      <h2 class="title">¿Qué te pedimos a cambio?</h2>
      Que hagas todo lo posible por mantener a tus empleados, y que pronto
      podamos disfrutar una comida todos juntos.
    </div>
  </div>
</template>
<script>
